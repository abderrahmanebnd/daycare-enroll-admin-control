  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const userNotifications =
        await notificationService.getNotificationsByUserId(user!.id);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="card-hover bg-gradient-to-br from-daycare-accent to-daycare-accent/80 text-daycare-dark">
            ...
            <CardContent>
              ...
              <p className="text-sm opacity-80">Messages non lus</p>
              <Button
                variant="secondary"
                size="sm"
          ...
          <Card className="card-hover bg-gradient-to-br from-daycare-dark to-daycare-dark/80 text-white">
            ...
            <CardContent>
              ...
              <p className="text-sm opacity-80">Notifications non lues</p>
              <Button
                variant="secondary"
                size="sm"
                      ...
                      <div key={request.id} className="border-b pb-3">
                        ...
                        <div className="flex gap-2 mt-2">
                          <Button
                            ...
                            onClick={() =>
                              navigate(`/admissions/${request.id}`)
                            }
                          >
                            Voir détails
                          </Button>
